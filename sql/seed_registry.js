...
const SITES=[
  ...
  {key:'korea',       badge:'KR',   short_label:'한국영업', title:'한국 영업',          body_html:'영업관리 · 진단키트 · 고객사', icon:'🇰🇷', grad_from:'#0891b2', grad_to:'#06b6d4', accent_color:'#0891b2', matrix_color:'#0891b2', url:'LOCAL',               sort_order:2},
  ...
  {key:'consumables', badge:'소모품',short_label:'소모품',  title:'소모품 매출',        body_html:'진단키트 · 노바몰', icon:'🧴', grad_from:'#7c3aed', grad_to:'#8b5cf6', accent_color:'#7c3aed', matrix_color:'#7c3aed', url:D+'consumables.html',  sort_order:7},
];
